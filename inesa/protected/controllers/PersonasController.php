...
class PersonasController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index', 'vistaempresas','create', 'admin', 'update', 'view'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Personas']))
		{
			...
			if($model->save())
				$this->redirect(array('admin','ventana'=>$ventana));
		}
		elseif(isset($_POST['Cargo']))
		{
			$model_cargo->attributes=$_POST['Cargo'];
			if($model_cargo->save())
				$this->redirect(array('create','ventana'=>$ventana));
			else
			{
				$ventana=true;
				$this->redirect(array('create','ventana'=>$ventana));
