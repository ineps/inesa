...
class Estados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('estados', 'required'),
			array('estados', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, estados', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'domicilioclientes' => array(self::HAS_MANY, 'Domiciliocliente', 'estados_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('estados',$this->estados,true);
