...
class Estatus extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'domicilioclientes' => array(self::HAS_MANY, 'Domiciliocliente', 'estatus_id'),
			'empresas' => array(self::HAS_MANY, 'Empresa', 'estatus_id'),
			'personases' => array(self::HAS_MANY, 'Personas', 'estatus_id'),
		);
	}
